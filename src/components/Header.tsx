...
const Header: FC<HeaderProps> = ({ toggleSideBar }) => {
    return (
        <header className="h-15 flex items-center justify-between bg-red-500 text-white px-6">
            <div className="flex items-center gap-1">
                ...
                <div className="leading-3.5">
                    <p className="font-bold">Practice Projects</p>
                    <p className="text-xs font-medium">By Sahil Saroj</p>
                </div>
            </div>
